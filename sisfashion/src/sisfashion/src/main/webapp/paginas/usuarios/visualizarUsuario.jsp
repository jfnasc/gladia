        ...
        <div class="panel-body">
            <form id="formCadastro" class="form-horizontal" data-toggle="validator" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <bean:write name="usuariosForm" property="nome" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <bean:write name="usuariosForm" property="email" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <bean:write name="usuariosForm" property="telefone" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <bean:write name="usuariosForm" property="perfil" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <bean:write name="usuariosForm" property="funcao.nome" />
                    </div>
                </div>
